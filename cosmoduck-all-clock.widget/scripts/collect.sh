#!/bin/bash
# Cosmoduck · tutto in uno con orologio -- raccoglie l'uscita dei singoli widget
# e la fonde.
#
# Copia di quello di cosmoduck-all.widget, parola per parola: le due varianti si
# installano l'una al posto dell'altra, e questa non puo' chiamare uno script che
# sta in una cartella che potresti non avere. Una correzione qui va fatta due
# volte, come per il calendario.
#
